...
def init_temp_dirs(temporary_path):
    sha1_cache_dir = os.path.join(temporary_path, 'sha1-cache')
    os.mkdir(sha1_cache_dir)
    cairio_dir = os.path.join(temporary_path, 'cairio')
    os.mkdir(cairio_dir)
    os.environ['KBUCKET_CACHE_DIR']=sha1_cache_dir
    os.environ['CAIRIO_DIR']=cairio_dir
