        ...
        <div style={{ margin: 25 }}>
            <Grid container spacing={3}>
                <Grid item xs={12} md={6} lg={5} xl={4}>
                    <div id="abc" style={{height: 200, overflow: 'auto'}}>
                    <BrowserTree
                        style={{overflow:'auto'}}
                        path={props.path}
...
class MainWindow extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            // path: 'sha1dir://761d34ed9456a35d35d005df5a435ee072b918ca',
            path: 'sha1dir://761d34ed9456a35d35d005df5a435ee072b918ca/example_recordings/synth_magland_001',
            pathHistory: [],
            currentItem: null
        };
