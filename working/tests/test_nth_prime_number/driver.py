...
def main():
    ...
    parser.add_argument(
        '--force_run', help='force run of processors', action="store_true")
    parser.add_argument(
        '--use_container', help='try running jobs in a singularity container', action='store_true')
    ...
    if args.command == 'stop':
        ...
        mlpr.executeBatch(jobs=jobs, num_workers=None,
                          compute_resource=compute_resource, batch_name=batch_name)
