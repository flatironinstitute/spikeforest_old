...
ca.autoConfig(collection='spikeforest',key='spikeforest2-readwrite',ask_password=True,password=password)
...
ca.saveObject(
    ...
    key=dict(name='spikeforest_recording_group',group_name='mearec_sqmea_test')
)
