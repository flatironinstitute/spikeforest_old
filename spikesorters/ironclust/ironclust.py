...
class IronClust(mlpr.Processor):
    ...
    detect_threshold=mlpr.FloatParameter(optional=True,default=5,description='detection threshold')
    prm_template_name=mlpr.StringParameter(optional=True,description='.prm template file name')
...
def ironclust_helper(*,
    ...
    se.MdaRecordingExtractor.writeRecording(recording=recording,save_path=dataset_dir,params=params)
    ...
    cmd_path = "addpath('{}', '{}/matlab', '{}/matlab/mdaio');".format(ironclust_path, ironclust_path, ironclust_path)
